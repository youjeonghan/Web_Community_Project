...
function board_management_container_init() {
	...
	function category_container_clear(){
		// 모든 child 삭제
		while ( category_select.hasChildNodes() ) { category_select.removeChild( category_select.lastChild ); }
	...
	<div class="category_modal manager_modal">
		...
		<div>
			<span>카테고리 추가</span>
			<input type="text" class="category_insert_name" placeholder="카테고리 이름">
			<button class="category_insert_btn">추가</button>
		</div>
	</div>
	</div>`;
	...
	<div class="board_modal manager_modal">
		...
		<div>
			<span>게시판 추가</span>
			<input type="text" class="board_insert_name" placeholder="게시판 이름">
			<input type="text" class="board_insert_description" placeholder="게시판 설명">
			<button class="board_insert_btn">추가</button>
		</div>
	</div>
	</div>`;
	...
	function category_insert_FetchAPI(category_name){
		...
		const send_data={'category_name' : category_name}
...
function report_management_container_init(){
	...
	const report_blacklist_btn = document.querySelector("#report_blacklist_btn");
	report_blacklist_btn.addEventListener("click", ()=>{
        ...
        // X 버튼 클릭시 모달 사라짐
        document.querySelector(".blacklist_exit").addEventListener("click", ()=> {
